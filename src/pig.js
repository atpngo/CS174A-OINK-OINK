...
export class Pig{
    constructor() {
        ...
        this.shapes = {
            ...
            pig_nose: new Shape_From_File("assets/pignose4.obj"),
        }

        this.materials = {
            pig: new Material(new Gouraud_Shader, {
                ambient: 0.85, diffusivity: 0,color:hex_color("#FFC0CB"),
            }),
            pigtail: new Material(new Gouraud_Shader, {
                ambient: 0.6, diffusivity: 0,color:hex_color("#FFC0CB"),
            }),
            pigeye: new Material(new Gouraud_Shader, {
                ambient: 0.5, diffusivity: 0,color:hex_color("#000000"),
            }),
            pignose: new Material(new Gouraud_Shader, {
                ambient: 0.7, diffusivity: 0,color:hex_color("#FFC0CB"),
            })
        }
